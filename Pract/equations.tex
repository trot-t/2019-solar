...
\left[
	\tilde{i}_1(0)\left(\omega\cos(\omega t) + \frac{(\alpha - \omega)^2}{2\alpha}\sin(\omega t) \right)
+ i_2(0)\frac{1}{2\alpha}\left(\omega\cos(\omega t)  + \alpha\sin(\omega t)\right)
\right]
$$
...
\left[
\tilde{i}_1(n)\left(\omega\cos(\omega\gamma T) + \frac{(\alpha - \omega)^2}{2\alpha}\sin(\omega\gamma T) \right)
...
\left[
\tilde{i}_1[n]\left(\omega\cos(\omega\gamma T) + \frac{(\alpha - \omega)^2}{2\alpha}\sin(\omega\gamma T) \right) \right. +
$$
$$
\left.
...
-\tilde{I}_1^*(q) \frac{(\alpha+\omega)^2}{2\alpha} sin(\omega\gamma T) 
...
&
{\displaystyle -\frac{e^{-\alpha\gamma T}}{\omega}\frac{(\alpha+\omega)^2}{2\alpha}\sin(\omega\gamma T)}\\
