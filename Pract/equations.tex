...
Результ моделирования в программе ngspice дает $V_{out}=158.197$ В (измеряем по нижнему краю, потому что в 
аналитическом решении первой считалась фаза I, когда ключ находится в состоянии низкой проводимости).
Ошибка от точного решения составляет 0.6\%.

Результ моделирования в программе matlab с решателем ode23tb дает $V_{out}=167.5$ В.
Ошибка от точного решения составляет 8.34 В или 5.2\%.

\begin{figure}[!ht]
\centering
\includegraphics[scale=0.3]{measure_all.png}
